...
theme.set_highlights = function()
	...
	hl(0, "DiffText", { fg = c.white, bg = c.green })
	hl(0, "DiffAdd", { fg = c.medium_green, bg = "NONE" })
	hl(0, "DiffChange", { fg = "NONE", bg = "NONE" })
	hl(0, "DiffDelete", { fg = c.sign_delete_bg, bg = "NONE" })
	...
	hl(0, "Constant", { fg = c.alt_fg, bg = "NONE" })
	hl(0, "Type", { fg = c.cyan, bg = "NONE" })
	hl(0, "Function", { fg = c.light_gray, bg = "NONE" })
	...
	hl(0, "Structure", { fg = c.alt_fg, bg = "NONE" })
	...
	hl(0, "Identifier", { fg = c.alt_fg, bg = "NONE" })
	...
	hl(0, "@parameter", { fg = c.alt_fg, bg = "NONE" })
	...
	hl(0, "@field", { fg = c.alt_fg, bg = "NONE" })
	hl(0, "@property", { fg = c.alt_fg, bg = "NONE" })
	...
	hl(0, "@tag", { link = "Tag" })
	hl(0, "@tag.attribute", { fg = c.alt_fg, bg = "NONE", italic = true })
	...
	hl(0, "CmpItemKindVariable", { fg = c.alt_fg, bg = "NONE" })
	hl(0, "CmpItemKindField", { fg = c.alt_fg, bg = "NONE" })
	hl(0, "CmpItemKindProperty", { fg = c.alt_fg, bg = "NONE" })
	...
	hl(0, "CmpItemKindReference", { fg = c.alt_fg, bg = "NONE" })
	hl(0, "CmpItemKindOperator", { fg = c.fg, bg = "NONE" })
	hl(0, "CmpItemKindTypeParameter", { fg = c.alt_fg, bg = "NONE" })
	...
	hl(0, "NeogitDiffDelete", { fg = c.light_red, bg = "NONE" })
	hl(0, "NeogitDiffDeleteHighlight", { fg = c.light_red, bg = "NONE" })
